...
with open(path_utils.path_to('readme_md'), 'w', encoding="UTF-8", errors="ignore") as outfile:
    with open(path_utils.path_to('about_md'), 'r', encoding="UTF-8", errors="ignore") as infile:
        outfile.write(infile.read())

    outfile.write('\n\n## Data Sources\n')
    with open(path_utils.path_to('sources_md'), 'r', encoding="UTF-8", errors="ignore") as infile:
        outfile.write(infile.read())
